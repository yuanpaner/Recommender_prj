# -*- coding: utf-8 -*-
""" content-base: using the items' property(genre and year);
    nonrelated to the behavior

    Here use the movie genre to calculate this,
    though there are a lot of properties
"""
...
class ContentKNNAlgorithm(AlgoBase):
    ...
    def computeYearSimilarity(self, movie1, movie2, years):
        ...
        sim = math.exp(-diff / 10.0) # smoothly scale to 0 - 1
        return sim
    ...
    def estimate(self, u, i):
        """ given user u and item i, estimate the rating score user will give i
        """
