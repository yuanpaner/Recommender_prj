...
class Evaluator:
    ...
    def SampleTopNRecs(self, ml, testSubject=85, k=10):
        ...
        for algo in self.algorithms:
            ...
            # recommendations.sort(key=lambda x: x[2], reverse=True) # by popularity rank, behavior-based data
            recommendations.sort(key=lambda x: x[1], reverse=True) # by estimated rating
