"""
train for each user, paper for each item
basically not different from RBM, except the normalized scores 
"""
...
class AutoRecAlgorithm(AlgoBase):
    ...
    def fit(self, trainset):
        ...
        for (uid, iid, rating) in trainset.all_ratings():
            trainingMatrix[int(uid), int(iid)] = rating / 5.0 #normalize
